...
const translations = {
  'ar': {
    ...
    "ecommerce": {
      ...
      "frequently_bought_together": "يُشترى معاً بشكل متكرر",
      "bundle_deal": "عرض مجموعة",
      "quantity": "الكمية",
      "size": "المقاس",
      "color": "اللون",
      "material": "المادة",
  ...
  'bn': {
    "common": {
      ...
      "sign_up": "সাইন আপ",
      "sign_out": "সাইন আউট",
      "access_account": "আপনার অ্যাকাউন্টে অ্যাক্সেস করুন",
      "flash_deals": "ফ্ল্যাশ ডিল"
    },
    "welcome": "আমাদের দোকানে স্বাগতম!",
    "description": "বিশ্বব্যাপী ট্রেন্ডিং পণ্যের সেরা ডিল খুঁজুন।",
...
function generateAllTranslations() {
  ...
  // Update the languages we have translations for
  Object.keys(translations).forEach(langCode => {
    createTranslationFile(langCode);
  });
  
  // For other languages, use the base structure (English)
