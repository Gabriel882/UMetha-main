...
interface AnimeOutfitFitterProps {
...
const outfitCategories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        availableColors: ["#dc2626", "#000000", "#8b5cf6"],
        size: "M",
        category: "tops"
      }
    ]
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        color: "#f59e0b",
        gender: "female" as const,
        availableColors: ["#f59e0b", "#8b5cf6", "#dc2626"],
        size: "S",
        category: "dresses"
      }
    ]
...
export default function AnimeOutfitFitter({ 
  onOutfitChange, 
  onClearAll,
  currentOutfit,
  className = "" 
}: AnimeOutfitFitterProps) {
            ...
            <Card className="overflow-hidden border-2 border-transparent hover:border-indigo-200 dark:hover:border-violet-800/50 transition-all">
              <div className="relative aspect-square">
                ...
                {item.gender && item.gender !== "unisex" && (
                  <div className="absolute top-2 right-2 bg-white/80 dark:bg-black/60 rounded-full px-2 py-1 text-xs font-medium">
                    {item.gender === "male" ? "♂" : "♀"}
                  </div>
                )}
              </div>
